...
(hh = h / 2),
  (opts = {
    ...
    strings: ["HAPPY", "BIRTHDAY!", "ZEHRA", "SIUUUUUUUU!"],
    charSize: 30,
    charSpacing: 35,
    lineHeight: 40,
...
function Letter(char, x, y) {
  ...
  var hue = x / calc.totalWidth < 0.5 ? 355 : 140;
...
// Show popup and play audio only after user clicks the button
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (btn) {
    ...
    // fallback: start immediately if no popup
    anim();
  }
});
